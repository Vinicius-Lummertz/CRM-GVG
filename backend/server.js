...
const templatesSync = require('./templates/sync');
...
const tasksCreate = require('./tasks/create');
const tasksUpdate = require('./tasks/update');
const tasksDelete = require('./tasks/delete');
const noteNotebooksGet = require('./notes/notebooks/get');
const noteNotebooksCreate = require('./notes/notebooks/create');
const noteNotebooksUpdate = require('./notes/notebooks/update');
const noteNotebooksDelete = require('./notes/notebooks/delete');
const notesGet = require('./notes/get');
const notesCreate = require('./notes/create');
const notesUpdate = require('./notes/update');
const notesDelete = require('./notes/delete');
...
const companiesUpdateSettings = require('./companies/updateSettings');
const companyChatConnectionGet = require('./companies/chatConnection/get');
const companyChatConnectionUpsert = require('./companies/chatConnection/upsert');
const companyChatConnectionUpdateStatus = require('./companies/chatConnection/updateStatus');
const companyWhatsappGet = deprecatedEndpoint('company_whatsapp_numbers');
const companyWhatsappCreate = deprecatedEndpoint('company_whatsapp_numbers');
const companyWhatsappUpdate = deprecatedEndpoint('company_whatsapp_numbers');
const companyWhatsappDelete = deprecatedEndpoint('company_whatsapp_numbers');
const companyMembersGet = require('./companies/members/get');
const companyMembersUpdate = require('./companies/members/update');
const companyInvitesGet = deprecatedEndpoint('company_member_invites');
const companyInvitesCreate = deprecatedEndpoint('company_member_invites');
const companyInvitesAccept = deprecatedEndpoint('company_member_invites');
...
app.post('/api/v2/templates/sync', templatesSync);
...
app.get('/api/v2/dashboard/summary', dashboardSummary);
app.get('/api/v2/tasks', tasksGet);
app.post('/api/v2/tasks', tasksCreate);
app.put('/api/v2/tasks/:taskId', tasksUpdate);
app.delete('/api/v2/tasks/:taskId', tasksDelete);
app.get('/api/v2/note-notebooks', noteNotebooksGet);
app.post('/api/v2/note-notebooks', noteNotebooksCreate);
app.put('/api/v2/note-notebooks/:notebookId', noteNotebooksUpdate);
app.delete('/api/v2/note-notebooks/:notebookId', noteNotebooksDelete);
app.get('/api/v2/notes', notesGet);
app.post('/api/v2/notes', notesCreate);
app.put('/api/v2/notes/:noteId', notesUpdate);
app.delete('/api/v2/notes/:noteId', notesDelete);
...
app.put('/api/v2/companies/:companyId/settings', companiesUpdateSettings);
app.get('/api/v2/companies/:companyId/chat-connection', companyChatConnectionGet);
app.put('/api/v2/companies/:companyId/chat-connection', companyChatConnectionUpsert);
app.put('/api/v2/companies/:companyId/chat-connection/status', companyChatConnectionUpdateStatus);
